  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
          ...
          <div className="lg:col-span-8 space-y-6" data-aos="fade-right">
            <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
              <h2 className="mb-6 text-lg font-bold text-gray-800 flex items-center gap-2">
                <Info size={20} className="text-green-600" /> Tham số AI bóc
                tách
              </h2>
              ...
              {aiData.imageUrl && (
                ...
                >
                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg flex items-center gap-2 text-xs font-bold text-gray-700 shadow-sm z-10">
                    <ImageIcon size={14} className="text-green-600" /> Ảnh gốc
                    đã phân tích
                  </div>
                  <img
                    src={aiData.imageUrl}
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                {/* Diện tích */}
                <div
                  className="group relative rounded-2xl border border-gray-100 bg-gray-50/50 p-6 transition-all hover:border-green-300 hover:bg-white hover:shadow-md"
                  data-aos="fade-up"
                  data-aos-delay="100"
                >
                ...
                >
                  ...
                  <div
                    className={`mt-2 inline-flex rounded-full border px-4 py-1 text-lg font-bold ${getMessinessColor(aiData.messiness)}`}
                  >
                    {aiData.messiness}
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl bg-green-600 p-6 text-white shadow-lg shadow-green-200">
                  ...
                  <div className="mt-2 flex items-baseline justify-between">
                    ...
                    <span className="text-lg font-bold uppercase pl-1">
                      VNĐ
                    </span>
                  </div>
                </div>
        ...
        <div
          className="mt-12 text-center text-gray-400 text-sm font-medium"
          data-aos="fade-up"
        >
          Báo giá AI được phân tích lúc {new Date().toLocaleTimeString("vi-VN")}{" "}
          • Đơn giá:{" "}
          {(rawAiData?.details?.price_per_m2 || 0).toLocaleString("vi-VN")}{" "}
          VNĐ/m²
        </div>
      </div>
    </div>
